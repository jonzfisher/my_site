...
import Segment from './blogs/Segment'
...
const SecondPage = () => (
  <div className="spectral mw7-ns center-ns">
    ...
    <Segment title="The Project" content="The site needed a redesign with the following being most important to Historical Homecrafters: a redesign for more mobile responsiveness, a clearer flow to make contact, and consideration for SEO." />
    <Segment title="The Constraints" list={["Timeline: 30-35 hours (!)", "A priority for large text and readability", "Approachable to non-tech world"]} />
    <Segment title="The Audiences" content="A large age-range, but usually not first-time homebuyers. Age 45 and above, all local to the Jefferson County area." />
    <Segment title="The Priorities" content="Have a clear call-to-action for contacting Historical Homecrafters. The owner is an honor to work with, so the faster I can start the conversation between him and the interested party, the better." />
    ...
    <Segment title="The Process" content="After listing out all the ideas that I’d like to apply to the site, I began placing all of them against their worst enemy: the aforementioned constraints and priorities. Many of them survived the battle, and I worked to include the ones I felt had the largest value adds, knowing that the smarter I executed, the more interesting stuff I could include." />
    <div className="w-100-ns mb0 mt4">
    ...
    <p className="f4 mb0 mt2">
      ...
      #471D1D <ColorSwatch hex="#471D1D" /> and
       #FFFFD9 <ColorSwatch hex="#FFFFD9" />) have a 14.1:1 contrast ratio, which is good at any
    ...
    <p className="f4 mb0 mt2">
      ...
      same for both darker reds (#471D1D <ColorSwatch hex="#471D1D" /> and
      #2E0F0F <ColorSwatch hex="#2E0F0F" />). This ends up helping the copy,
      through trick of the eye, to jump off the screen a bit and gives the rendering
